...
const Header = () => {
  ...
  return (
    <header className="fixed shadow-md w-full z-100 m-0 h-20 px-2 md:px-4 z-50 bg-green-600 flex items-center justify-between">
      <div className="flex items-center">
        <Link to="/">
          <div className="flex items-center h-12">
            <img
              src={logo}
              className="h-16 w-auto mr-2 transform scale-100 hover:scale-110 transition duration-300"
              alt="Farm Logo"
            />
            <h1 className="text-4xl font-bold">AgriKonn</h1>
          </div>
        </Link>
      </div>
      <div className="flex items-center gap-4 ml-auto">
        ...
        >
          <div className="border-2 border-solid border-slate-600 text-3xl cursor-pointer rounded-full overflow-hidden drop-shadow-md hover:scale-110 transition duration-300">
