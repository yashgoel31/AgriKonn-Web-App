...
const cardsData = [
  {
    heading: "About Us",
    content: "At AgriKonn, we believe in connecting farmers directly with consumers, fostering a community where fresh, locally-sourced produce is easily accessible to everyone. Our platform serves as a marketplace where farmers can showcase their hard work and dedication while offering buyers the opportunity to discover and purchase high-quality, farm-fresh products from the comfort of their homes."
  },
  {
    heading: "Our Story",
    content: "Inspired by a passion for sustainable agriculture and a desire to support local farmers, AgriKonn was founded with a mission to revolutionize the way people access and enjoy farm-fresh goods. We understand the challenges faced by farmers in reaching consumers, and we aim to bridge this gap by providing a user-friendly platform that promotes transparency, fairness, and sustainability."
  },
  {
    heading: "Our Farmers",
